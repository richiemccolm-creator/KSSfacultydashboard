...
(function(global) {
  ...
  function buildSeed() {
    ...
    var priorAttainment = [
      ...
      { id: uid('pa'), pupil_id: 'p-jared-keith', subject_area: 'Drama', qualification_year: '2024-25', qualification_level: 'National 5', result_grade: '', pathway_status: 'Crashing subject', notes: '', created_at: ts, updated_at: ts },
